...
class GmailMultiSelectList extends StatefulWidget{
  ...
  VoidCallback clearSelection;
   ...
   GmailMultiSelectList({this.itemBuilder,this.itemCount,this.defaultAppBar,this.actions, this.selections,this.clearSelection});
...
class _GmailMultiSelectListState extends State<GmailMultiSelectList>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: widget.selections.length==0?widget.defaultAppBar:AppBar(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, idx) {return Card(color: Colors.white,
            child:widget.itemBuilder(context,idx));
